...
global lDialogArgumentsPlaceholder := "You can insert the location or part of it using these placeholders: {LOC} (full location), {NAME} (file name), {DIR} (directory), {EXT} (extension), {NOEXT} (file name without extension) or {DRIVE} (drive)"
...
global lDialogFavoriteTypesHelp1 := "Create a menu shortcut to a frequently used ""Folder"".`n`nSet the folder's name, path and various menu options.`n`nAdvanced settings allow to set window's position and file manager options." ; new
global lDialogFavoriteTypesHelp2 := "Create a menu shortcut to a ""Document"".`n`nSet the document's name, path and various menu options.`n`nAdvanced settings allow to choose a specific application to launch the document." ; new
global lDialogFavoriteTypesHelp3 := "Create a menu shortcut to an ""Application"" (program, batch or script).`n`nBrowse for the executable file or select one of the currently running programs. Set various menu options.`n`nAdvanced settings allow to select a ""Start In"" directory and other parameters." ; new
global lDialogFavoriteTypesHelp4 := "Create a menu shortcut to one of the 50 pre-defined Windows ""Special Folders"" suchs as: Libraries, My Pictures, Recycle Bin, Downloads, etc.`n`nSet various menu options. Advanced settings allow to set window's position and file manager options." ; new
global lDialogFavoriteTypesHelp5 := "Create a menu ""Link"" to a web page.`n`nSet menu name, web page's address (URL) and various menu options.`n`nAdvanced settings allow to select a specific browser to launch the link." ; new
global lDialogFavoriteTypesHelp6 := "Create a menu shortcut to an ""FTP site"".`n`nSet menu name, FTP site's address (URL), login name, password and various menu options.`n`nAdvanced settings allow to select a specific FTP program to access this site." ; new
...
global lDialogMouseNone := "None" ; lOptionsMouseNone renamed
...
global lHelpText1 := "At its launch, Quick Access Popup adds an icon in the System Tray and await your orders. When you need to change the current folder in Windows Explorer or in a file dialog box, just click the [~1~] or press [~2~] and, in the popup menu, select the desired folder. Quick Access Popup will take you there this instantly! Or use it to open quickly a favorite document or web page."
global lHelpText2 := "Choose ""Settings"" to open the Quick Access Popup settings window where you can add favorite FOLDERS, DOCUMENTS or WEB LINKS to your menu. You can move, rename or delete them. You can also add, move, rename or delete SUBMENUS. Choose the ""Menu to edit:"" in the  drop-down list. Click ""Save"" to save your changes."
...
global lHelpText4 := "To add a new favorite DOCUMENT or WEB LINK to the popup menu:`n1) Open the Quick Access Popup menu and choose ""Settings"" (or press [~1~]).`n2) Click the ""Add"" button and choose the option ""Document"" or ""Link (URL)"".`n3) Give the favorite a short name, ""Browse"" to the document or enter the web page's URL, click ""Add"", then ""Save"" in the settings window."
global lHelpText5 := "- In the Tray menu, right-click on the Quick Access Popup icon and check the ""Run at Startup"" option to launch Quick Access Popup automatically at startup.`n- Need a new file Explorer window while working in an application? From any window, click [~1~] (or press [~2~]), or simply click on the Quick Access Popup icon in the System Tray, and choose your favorite folder.`n- Choose the ""Recent folders..."" menu (or press [~3~]) to show an updated list of the Windows recent folders.`n- Use the ""Current Folders"" menu (or press [~4~]) to open one of the folders already open in an Explorer window or the ""Groups of Favorites"" menu (or press [~5~]) to save and restore groups of folders.`n- Access the files or URLs in your Clipboard from the ""Clipboard"" menu (or press [~6~]) or copy the path or URL of any favorite to the Clipboard using the ""Copy a Favorite's Path or URL"" menu (or press [~7~]).`n- Configure your popup menu triggers: choose your preferred mouse buttons or keyboard shortcuts in ""Settings, Options"".`n- Also in ""Options"": choose your preferred language, menu icons size, windows colors. Select the options to display recent folders, add numeric keyboard shortcuts to the folders menu or pin the popup menu at a fix position.`n-Directory Opus users, see <a href=""http://code.jeanlalonde.ca/using-folderspopup-with-directory-opus/"">this page</a> for additional information.`n-Total Commander users, see <a href=""http://code.jeanlalonde.ca/using-folderspopup-with-total-commander/"">this page</a> for additional information." ; changed, was ... "Groups of Folders"...
global lHelpText6 := "Support on Quick Access Popup is available at <a href=""http://www.quickaccesspopup.com"">www.quickaccesspopup.com</a>."
global lHelpTextLead := "Quick Access Popup lets you move like a breeze between your frequently used folders, documents and web pages!"
...
; global lOptionsArrDescriptions7 := "Choose the hotkey or mouse button combination that will open the ""Groups of Favorites"" menu. By default, this is Shift+Control+G." ; changed, was ... "Groups of Folders"...
...
global lOptionsDisplayGroupMenu := "&Group of Favorites" ; REMOVED, was ... "Groups of Folders"...
...
global lOptionsHotkeys := "Exclusion list"
...
global lOptionsRecentFolders := "Number of Recen&t Folders in menu" ; changed
...
global lOptionsTitles := "Quick Access Popup Mouse button|Quick Access Popup Keyboard shortcut|Power Menu Mouse button|Power Menu Keyboard shortcut"
global lOptionsTitlesSub := "This mouse button pops the menu anywhere (except over <a>excluded applications</a>) and launch your favorite or navigate to your folder.|This hotkey the menu anywhere (except over <a>excluded applications</a>) and launch your favorite or navigate to your folder.|This mouse pops an alternate menu offering various features. This menu can pop anywhere (without exception).|This hotkey pops an alternate menu offering various features. This menu can pop anywhere (without exception)." ; changed
...
global lTrayTipNoCurrentFoldersMenuDetail := "There is currently no folder to display in the Current Folders menu"
global lTrayTipNoCurrentFoldersMenuTitle := "~1~ - Current folders"
