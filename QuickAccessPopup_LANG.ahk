...
global lDialogInvalidHotkeyFavorite := "With your current system keyboard layout, the hotkey ""~1~"" could not be used as a trigger for the location of favorite ""~2~"" (not a valid key name error).`n`nPlease, choose another shortcut for location ""~3~""." ; new
