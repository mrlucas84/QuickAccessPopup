...
global lDialogFavoriteTypesHelp9 := "Launch a ""Group"" of favorites, all in one menu shortcut!`n`nGive your group a name and set various options for your group.`n`nAdd favorites to your group or move them from other submenus or groups using the ""Edit"" button." ; new
