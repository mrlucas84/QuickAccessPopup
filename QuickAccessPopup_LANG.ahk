...
global lDialogFavoriteTypesHelp := "Folder help|Document help|Application help|Special Folder help|Link (URL) help|FTP site help|QAP Feature help|Menu help" ; new to be completed in English
global lDialogFavoriteTypesLabels := "&Folder|&Document|&Application|&Special Folder|&Link (URL)|F&TP site|&QAP Feature|Sub&menu" ; new (but replace lDialogFolderLabel, lDialogFileLabel, lDialogApplicationLabel, lDialogSpecialLabel, lDialogURLLabel, lDialogSubmenuLabel ("FTP site" and "QAP Feature" are new)
...
global lDialogLaunchWith := "Launch with" ; new
