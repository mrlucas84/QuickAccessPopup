...
global lDialogFavoriteSelectType := "Select the type of favorite to add.`n`nIn the next window, you will give your favorite:`n- a name`n- a content (depending on the type)`n- various options (icon, shortcut, etc.)`n`nClick ""~1~"" after you selected the type of the new favorite."
