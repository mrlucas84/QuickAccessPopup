...
global lDialogFavoriteSelectType := "Select the type of favorite to add.`n`nIn the next window, you will give your favorite:`n- a name`n- a content (depending on the type)`n- various settings (icon, shortcut, etc.)`n`nClick ""~1~"" after you selected the type of the new favorite."
...
global lDialogFavoriteTypesHelp := "Folder help|Document help|Application help|Special Folder help|Link help|FTP site help|QAP Feature help|Menu help" ; new to be completed in English
global lDialogFavoriteTypesLabels := "&Folder|&Document|&Application|&Special Folder|&Link|F&TP site|&QAP Feature|Sub&menu" ; new (but replace lDialogFolderLabel, lDialogFileLabel, lDialogApplicationLabel, lDialogSpecialLabel, lDialogURLLabel, lDialogSubmenuLabel ("FTP site" and "QAP Feature" are new) ; new
global lDialogFavoriteTypesPositionLabels := "Folder (path)|Document (path and file name)|Application (path and file name)||Link (URL)|FTP site (URL)||" ; new
global lDialogFavoriteTypesShortNames := "Folder|Doc|App|Special|Link|FTP|QAP|Menu" ; new
