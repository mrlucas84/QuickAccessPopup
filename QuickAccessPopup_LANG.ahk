...
global lHelpText32 := "- Choose the ""Recent folders..."" menu to show an updated list of the Windows recent folders.`n- Use the ""Reopen a Folder"" menu to reopen one of the folders already open in an Explorer window (very useful in file dialog boxes).`n- Access the files or URLs in your Clipboard with the ""Clipboard"" menu." ; new
