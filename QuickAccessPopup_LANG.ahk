...
global lHelpText21 := "To add favorites, in the ""Settings"" window, click the ""Add"" button. Select the type of the new favorite and see the tips on the right side of the widow. Click ""Continue"" to open the ""Add Favorite"" dialog box." ; new
...
global lHelpText23 := "ADD THIS FOLDER`n`nTo quickly ADD a new favorite FOLDER to the popup menu:`n1) Go to a frequently used folder.`n2) Click the QAP hotkey [~1~] or [~2~], choose the ""My QAP Essentials"" menu and click ""Add This Folder"".`n3) Give the folder a short name, click ""Add"", then ""Save"" in the Settings window." ; new
global lHelpText31 := "In the ""My QAP Essentials"" menu:" ; new
global lHelpText32 := "- Choose the ""Recent folders..."" menu to show an updated list of the Windows recent folders.`n- Use the ""Reuse an Open Folder"" menu to reopen one of the folders already open in an Explorer window (very useful in file dialog boxes).`n- Access the files or URLs in your Clipboard with the ""Clipboard"" menu." ; new
global lHelpText33 := "CUSTOMIZE YOUR QAP FEATURES MENU`n`nYou can move the ""My QAP Essentials"" menu items to the main menu or to other submenus as you wish.`n`n1) Select the ""Settings"" menu (or hit [~1~]).`n2) In the ""Menu or group to edit:"" drop-down list, select ""Main > My QAP Essentials"".`n3) Select the QAP feature to move and click ""Edit"".`n4) In the ""Menu Options"" tab, select the new ""Favorite Parent menu"".`n5) Save your changes." ; new
...
global lMenuCurrentFolders := "Reuse an Open Folder"
...
global lMenuSwitchFolderOrApp := "Switch to an Open Folder or Application"
