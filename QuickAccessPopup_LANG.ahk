...
global lDialogHotkeysManageAbout := "About Hotkeys"
global lDialogHotkeysManageIntro := "..."
global lDialogHotkeysManagePopup := "Popup"
global lDialogHotkeysManageListHeader := "Hotkey|Favorite Name|Type|Location" ; new
global lDialogHotkeysManageListSeeAllFavorites := "See all favorites" ; new
global lDialogHotkeysManageListSeeFullHotkeyNames := "See full hotkey names" ; new
...
global lDialogInvalidHotkeyFavorite := "With your current system keyboard layout, the hotkey ""~1~"" could not be used as a trigger for this favorite (not a valid key name error).`n`nPlease, choose another shortcut for ""~2~""." ; new
...
global lOopsHotkeyAlreadyUsed := "The hotkey ""~1~"" is already used for ~2~.`n`nPlease, choose another hotkey for ""~3~""."
global lOopsHotkeyFavorite := "the ""~1~"" favorite hotkey"
global lOopsHotkeyNotInMenus := "Error: hotkey ~1~ not found in menus."
global lOopsHotkeyPopupMenu := "the ""~1~"" hotkey"
