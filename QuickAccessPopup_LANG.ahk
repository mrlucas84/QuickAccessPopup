...
global lOptionsTitles := "Mouse button for Quick Access Popup menu|Keyboard shortcut for Quick Access Popup menu|Mouse button alternate menu|Keyboard shortcut for alternate menu"
global lOptionsTitlesSub := "### 1 This mouse button can pop the menu over Windows Explorer, supported third-party file managers and dialog boxes windows.|### 2 This mouse button can pop menu anywhere on the screen.|### 3 This hotkey can pop the menu when a Windows Explorer, a supported third-party file manager or a dialog box is active.|### 4 This hotkey can pop the menu anytime." ; changed
