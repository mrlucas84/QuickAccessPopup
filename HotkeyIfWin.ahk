...
###_D("A_ThisLabel: " . A_ThisLabel . "`ng_strTargetWinId: " . g_strTargetWinId . "`ng_strTargetClass: " . g_strTargetClass . "`ng_strTargetControl: " . g_strTargetControl)
...
;------------------------------------------------------------
{
	if (strMouseOrKeyboard = g_strMouseNavigateHotkey)
	{
		MouseGetPos, , , g_strTargetWinId, g_strTargetControl
		WinGetClass g_strTargetClass, % "ahk_id " . g_strTargetWinId
		TrayTip, Mouse, %strMouseOrKeyboard% = %g_strMouseNavigateHotkey% (%g_intCounter%)`n%g_strTargetWinId%`n%g_strTargetClass%`n%g_strTargetControl%
	}
	else
	{
		...
		g_strTargetControl := ""
		WinGetClass g_strTargetClass, % "ahk_id " . g_strTargetWinId
		TrayTip, Keyboard, %strMouseOrKeyboard% = %g_strKeyboardNavigateHotkey% (%g_intCounter%)`n%g_strTargetWinId%`n%g_strTargetClass%
	}
